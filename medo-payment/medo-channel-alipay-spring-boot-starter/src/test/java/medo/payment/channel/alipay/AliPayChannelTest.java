...
public class AliPayChannelTest {
    ...
    @Autowired private ChannelClient aliPayChannel;

    @Test
    public void testGetToken() {
        ChannelGetTokenRequest channelGetTokenRequest =
                ChannelGetTokenRequest.builder().authCode("test").build();
    ...
    public void testPreCreate() {
        ChannelPreCreateRequest channelMicroPayRequest =
                ChannelPreCreateRequest.builder()
                        .money(new Money(101))
                        .paymentId("1234")
    ...
    public void testFetchPayment() {
        ...
        ChannelFetchPaymentRequest channelFetchPaymentRequest2 =
                ChannelFetchPaymentRequest.builder().paymentId("1234").build();
        ChannelBaseResponse channelBaseResponse2 =
                aliPayChannel.fetchPayment(channelFetchPaymentRequest2);
    ...
    public void testRefund() {
        ChannelRefundRequest channelRefundRequest =
                ChannelRefundRequest.builder().paymentId("1234").money(new Money("20")).build();
    ...
    public void testFetchRefund() {
        ChannelFetchRefundRequest channelFetchRefundRequest =
                ChannelFetchRefundRequest.builder().paymentId("xx").refundId("xxx").build();
        ChannelBaseResponse channelBaseResponse =
                aliPayChannel.fetchRefund(channelFetchRefundRequest);
        Assert.assertTrue(channelBaseResponse.isFail());
    }
    ...
    public void testClose() {
        ChannelCloseRequest channelCloseRequest =
                ChannelCloseRequest.builder().paymentId("xxx").build();
    ...
    public void testCancel() {
        ChannelCancelRequest channelCancelRequest =
                ChannelCancelRequest.builder().paymentId("xx").build();
