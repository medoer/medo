...
public class MessagingTest {
    ...
    public void shouldReceiveMessage() throws InterruptedException {
        messageConsumer.subscribe(
                subscriberId, Collections.singleton(destination), this::handleMessage);
    ...
    public void receiveMessage() {
        //        messageConsumer.subscribe("destination1598352156025",
        // Collections.singleton("destination1598352156025"),
        //                (message) -> {
