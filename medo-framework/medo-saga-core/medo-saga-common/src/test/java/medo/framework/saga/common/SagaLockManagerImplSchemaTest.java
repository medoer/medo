...
public abstract class SagaLockManagerImplSchemaTest {
    ...
    public void testInsertIntoSagaLockTable() {
        Assert.assertEquals(
                getExpectedInsertIntoSagaLockTable(),
                getSagaLockManager().getInsertIntoSagaLockTableSql());
    }

    @Test
    public void testInsertIntoSagaStashTable() {
        Assert.assertEquals(
                getExpectedInsertIntoSagaStashTable(),
                getSagaLockManager().getInsertIntoSagaStashTableSql());
    }

    @Test
    public void testSelectFromSagaLockTable() {
        Assert.assertEquals(
                getExpectedSelectFromSagaLockTable(),
                getSagaLockManager().getSelectFromSagaLockTableSql());
    }

    @Test
    public void testSelectFromSagaStashTable() {
        Assert.assertEquals(
                getExpectedSelectFromSagaStashTable(),
                getSagaLockManager().getSelectFromSagaStashTableSql());
    }

    @Test
    public void testUpdateSagaLockTable() {
        Assert.assertEquals(
                getExpectedUpdateSagaLockTable(), getSagaLockManager().getUpdateSagaLockTableSql());
    }

    @Test
    public void testDeleteFromSagaLockTable() {
        Assert.assertEquals(
                getExpectedDeleteFromSagaLockTable(),
                getSagaLockManager().getDeleteFromSagaLockTableSql());
    }

    @Test
    public void testDeleteFromSagaStashTable() {
        Assert.assertEquals(
                getExpectedDeleteFromSagaStashTable(),
                getSagaLockManager().getDeleteFromSagaStashTableSql());
    }
