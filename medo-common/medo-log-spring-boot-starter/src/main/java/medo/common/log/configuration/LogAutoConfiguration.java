...
public class LogAutoConfiguration {
    ...
    public DbAuditServiceImpl dbAuditServiceImpl(
            LogDbProperties logDbProperties, DataSource dataSource) {
    ...
    public AuditLogAspect auditLogAspect(
            AuditLogProperties auditLogProperties, IAuditService auditService) {
